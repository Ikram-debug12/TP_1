...
public class App {
    ...
    private static void insererProduits(EntityManagerFactory emf) {
        ...
        try {
            ...
            Produit p1 = new Produit("Laptop", new BigDecimal("999.99"), 10);  // ✅ + quantite
            Produit p2 = new Produit("Smartphone", new BigDecimal("499.99"), 25);
            Produit p3 = new Produit("Tablette", new BigDecimal("299.99"), 15);
